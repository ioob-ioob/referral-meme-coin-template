...
// File: contracts/ReferralMemeLink.sol
...
contract ReferralToken is IERC20, IERC20Metadata, Ownable {
    ...
    // DEX link for the token
    string private dexLink;
    ...
    // Set the DEX link for the token
    function setDexLink(string memory newDexLink) public onlyOwner {
        dexLink = newDexLink;
    }

    // Get the DEX link for the token
    function getDexLink() public view returns (string memory) {
        return dexLink;
    }
    ...
    function _transfer(
        ...
        // Calculate referral or developer fees
        uint256 feeAmount = 0;
